...
# Simulations
tic()
dat01<-pattern_model_2d(0,cap,"l",sp0,e0)
dat02<-pattern_model_2d(0.001,"n","l",sp0,e0)
dat03<-pattern_model_2d(0.001,"p","l",sp0,e0)
dat04<-pattern_model_2d(0.001,"p","nl",sp0,e0)
toc()
...
tic()
dat11<-pattern_model_2d(0,cap,"l",sp0,e1)
dat12<-pattern_model_2d(0.001,"n","l",sp0,e1)
dat13<-pattern_model_2d(0.001,"p","l",sp0,e1)
dat14<-pattern_model_2d(0.001,"p","nl",sp0,e1)
toc()
